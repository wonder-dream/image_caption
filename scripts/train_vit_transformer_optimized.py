"""
ViT + Transformer 图像描述模型 - 优化版训练脚本
...
class MetricsHistory:
    ...
    def plot_and_save(self, save_path):
        ...
        fig.suptitle("Optimized Training Metrics", fontsize=16)
...
def train_optimized(config):
    ...
    if config.get("use_tensorboard", False):
        writer = SummaryWriter(log_dir=config.get("log_dir", "runs/vit_transformer_optimized"))
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("ViT + Transformer 图像描述模型 - 优化版训练")
    print("=" * 70)
    print("\n配置:")
